...
import { CloudUpload, FileArchive, AlertCircle } from "lucide-react"
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        ...
        description: `APK file uploaded successfully. Redirecting to analysis...`,
      })
    ...
    <Card className="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700">
      <CardContent className="p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">Drag and drop your APK file or click to browse</p>
            ...
            {isUploading ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    {uploadProgress === 100 ? "Preparing analysis..." : `${uploadProgress}% complete`}
                  </p>
                </div>
              </div>
            ) : (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Supports .apk files up to 100MB</p>
                </div>
                <Button className="bg-blue-600 hover:bg-blue-700 text-white" disabled={isUploading}>
                  Select File
                </Button>
              </div>
            )}
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-left">
                <h3 className="font-medium text-blue-800 dark:text-blue-200 mb-1">Security Analysis Guidelines</h3>
